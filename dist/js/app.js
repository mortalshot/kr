(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".showcase_4 .showcase__slider")) new core(".showcase_4 .showcase__slider", {
            modules: [ Navigation, Lazy ],
            slidesPerView: 2,
            spaceBetween: 20,
            autoHeight: false,
        ...
        if (document.querySelector(".gallery-product")) {
            ...
            function galleryProductHandleMd2Change(e) {
                if (e.matches) {
                    const productThumbsSlider = new core(".gallery-product__thumbs", {
                        modules: [ Thumb ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 4,
        ...
        if (document.querySelector(".product-color__slider")) new core(".product-color__slider", {
            modules: [ Navigation, Lazy ],
            slidesPerView: 5,
            spaceBetween: 8,
            autoHeight: false,
...
***************************************************************************** */
    ...
    if (attributeItems.length > 0) document.addEventListener("selectCallback", (function(e) {
        ...
        if ("number" === currentSelect.getAttribute("name")) {
